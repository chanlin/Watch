package com.jajale.watch.thirdpart.qrcode;

import com.jajale.watch.R;
import com.jajale.watch.activity.ScannerActivity;
...
public class ViewFinderView extends View {
    ...
    private static final int MIN_FRAME_WIDTH = 140;
    private static final int MIN_FRAME_HEIGHT = 240;

    private static final float LANDSCAPE_WIDTH_RATIO = 5f/8;
    private static final float LANDSCAPE_HEIGHT_RATIO = 5f/8;
    private static final int LANDSCAPE_MAX_FRAME_WIDTH = (int) (ScannerActivity.width*0.8 * LANDSCAPE_WIDTH_RATIO); // = 5/8 * 1920
    ...
    private static final int PORTRAIT_MAX_FRAME_WIDTH = (int) (ScannerActivity.width*0.6* PORTRAIT_WIDTH_RATIO); // = 7/8 * 1080
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        Paint paint = new Paint();
        Resources resources = getResources();
        paint.setColor(resources.getColor(R.color.viewfinder_border_green));
        ...
        canvas.drawLine(mFramingRect.left - 1, mFramingRect.top - 3, mFramingRect.left - 1, mFramingRect.top - 1 + lineLength, paint);
        canvas.drawLine(mFramingRect.left - 1, mFramingRect.top - 1, mFramingRect.left - 1 + lineLength, mFramingRect.top - 1, paint);
        canvas.drawLine(mFramingRect.left - 1, mFramingRect.bottom + 3, mFramingRect.left - 1, mFramingRect.bottom + 1 - lineLength, paint);
        canvas.drawLine(mFramingRect.left - 1, mFramingRect.bottom + 1, mFramingRect.left - 1 + lineLength, mFramingRect.bottom + 1, paint);

        canvas.drawLine(mFramingRect.right + 1, mFramingRect.top - 3, mFramingRect.right + 1, mFramingRect.top - 1 + lineLength, paint);
        canvas.drawLine(mFramingRect.right + 1, mFramingRect.top - 1, mFramingRect.right + 1 - lineLength, mFramingRect.top - 1, paint);

        canvas.drawLine(mFramingRect.right + 1, mFramingRect.bottom + 3, mFramingRect.right + 1, mFramingRect.bottom + 1 - lineLength, paint);
...
//        paint.setColor(resources.getColor(R.color.viewfinder_laser));
    ...
    public synchronized void updateFramingRect() {
        ...
        L.e("LANDSCAPE_MAX_FRAME_WIDTH===" + LANDSCAPE_MAX_FRAME_WIDTH);
        if(orientation != Configuration.ORIENTATION_PORTRAIT) {
            ...
            L.e("PORTRAIT_MAX_FRAME_WIDTH==="+PORTRAIT_MAX_FRAME_WIDTH);
