...
/**
 * Created by athena on 2016/2/16.
...
//    private AdapterView.OnItemClickListener itemClickListener ;
    private ADItemClickListener itemSelectedListener ;
...
//        initImageLoader(context);
    ...
    public void setImagesUrl(String[] imagesUrl,ADItemClickListener listener) {
...
//            if ( i == 0 ){
//                JJLImageLoader.downloadNormal(context,imagesUrl[count -1],iv);
//            }

            if (i == 0) {
                JJLImageLoader.downloadAD(context, imagesUrl[count - 1], iv);
            } else if (i == count + 1) {
                JJLImageLoader.downloadAD(context, imagesUrl[0], iv);
//                mImageLoader.displayImage(imagesUrl[0], iv, options);
            } else {
                JJLImageLoader.downloadAD(context, imagesUrl[i - 1], iv);
//                mImageLoader.displayImage(imagesUrl[i - 1], iv, options);
            }
...
//    }
    ...
    class KannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            ImageView target = imageViews.get(position);
