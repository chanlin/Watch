...
public class ParentHeadViewUtils {
    ...
    public static int[] mHeadView = {R.mipmap.head_image_father, R.mipmap.head_image_mother, R.mipmap.head_image_grandfather
            , R.mipmap.head_image_grandmother, R.mipmap.head_image_grandfather_mom, R.mipmap.head_image_grandmother_mom
            , R.mipmap.head_image_brother, R.mipmap.head_image_sister, R.mipmap.head_image_other};
