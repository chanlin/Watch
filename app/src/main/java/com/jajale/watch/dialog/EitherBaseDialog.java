 ...
 */
public class EitherBaseDialog extends Dialog implements View.OnClickListener {
    ...
    public EitherBaseDialog(Context context, String title, CharSequence bodyUp, CharSequence bodyDown, String leftBtn, String rightBtn, SimpleClickListener listener){
        super(context);
//        this.mContext = context ;
        ...
        setContentView(R.layout.dialog_base_either);
