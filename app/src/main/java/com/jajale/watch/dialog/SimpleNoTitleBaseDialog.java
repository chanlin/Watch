 ...
 */
public class SimpleNoTitleBaseDialog extends Dialog implements View.OnClickListener {
    ...
    public SimpleNoTitleBaseDialog(Context context, String title, CharSequence bodyUp, CharSequence bodyDown, String leftBtn, String rightBtn, SimpleClickListener listener){
        super(context);
//        this.mContext = context ;
        ...
        setContentView(R.layout.dialog_simple_base_no_title);
