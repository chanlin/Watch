 ...
 */
public class SimpleSingleMsgDialog extends Dialog implements View.OnClickListener{
    ...
    public SimpleSingleMsgDialog(Context context, CharSequence bodyUp, CharSequence bodyDown, String leftBtn, String rightBtn, SimpleClickListener listener){
        super(context);
...
//        this.dialogTitle = title;
        ...
        setContentView(R.layout.dialog_simple_base_single_msg);
...
//        ((TextView)findViewById(R.id.tv_dialog_title)).setText(dialogTitle);
        ...
        if (bodyDown.equals("")){
            findViewById(R.id.dialog_body_bottom).setVisibility(View.VISIBLE);
        }else{
