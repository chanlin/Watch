...
//    private int laytouID = -1;
    ...
    public SimpleBaseDialog(Context context, String title, CharSequence bodyUp, CharSequence bodyDown, String leftBtn, String rightBtn, SimpleClickListener listener){
        super(context);
//        this.mContext = context ;
    ...
    public SimpleBaseDialog(Context context,int layoutID ,String title, CharSequence bodyUp, CharSequence bodyDown, String leftBtn, String rightBtn, SimpleClickListener listener){
        super(context);
//        this.mContext = context ;
        this.sClickListener = listener;
        this.dialogTitle = title;
